...
I fit a normal model where $\beta_1$ is the slope coefficient that measures the caste specific marginal effect of social engagement degree on the degree in the borrowing network. I use weakly informative [@gelman2017prior] normal priors on the parameters $\beta_0$, $\beta_1$ and $\mu_c$. I use a half-Cauchy prior on variances $\tau_c$ and $\sigma$ as this distribution has most of its mass at the mean 0 but has smooth slopes and long tails placing some mass significantly away from 0 allowing variance to creep into the model [@gelman2006prior], but simultaneously constraining the space the chains of the HMC have to explore.
...
<!-- <!-- parameters{ --> -->
<!-- <!--   real <lower = 0.1> b1[4]; --> -->
<!-- <!--   real <lower = 0.1> lambda_c; --> -->
<!-- <!-- } --> -->
<!-- <!-- model{ --> -->
<!-- <!--   for(i in 1:N){ --> -->
<!-- <!--     deg_74[i] ~ exponential(b1[cas_74[i]]*deg_social_eng[i]); --> -->
<!-- <!--   } --> -->
<!-- <!--   b1 ~ exponential(lambda_c); --> -->
<!-- <!--   lambda_c ~ exponential(2); --> -->

<!-- <!-- } --> -->
<!-- <!-- generated quantities{ --> -->
<!-- <!--   real y_pred[N]; --> -->
<!-- <!--   for(i in 1:N){ --> -->
<!-- <!--     y_pred[i] = exponential_rng(b1[cas_74[i]]*deg_social_eng[i]); --> -->
<!-- <!--   } --> -->
<!-- <!-- } --> -->
<!-- <!-- " --> -->
...
<!-- <!-- ```{r, echo = F} --> -->
<!-- <!-- ext3 <- extract(fit3) --> -->
<!-- <!-- print(fit3, pars = c("b1","lambda_c")) --> -->
<!-- <!-- ``` --> -->

<!-- <!-- ```{r, echo = F} --> -->
<!-- <!-- #exponential model caste --> -->
<!-- <!-- l_95_caste <- rep(NA, 4) --> -->
<!-- <!-- u_95_caste <- rep(NA, 4) --> -->
<!-- <!-- # --> -->
<!-- <!-- par(col = "gray") --> -->
<!-- <!-- for(i in 1:4){ --> -->
<!-- <!--   l_95_caste[i] <- quantile(ext3$b1[,i], probs = 0.025) --> -->
<!-- <!--   u_95_caste[i] <- quantile(ext3$b1[,i], probs = 0.975) --> -->
<!-- <!-- } --> -->
<!-- <!-- plot(colMeans(ext3$b1)[order(colMeans(ext3$b1))], --> -->
<!-- <!--      c(1,2,3,4), --> -->
<!-- <!--      xlim = c(-0.1,0.7), --> -->
<!-- <!--      main = "access to credit vs. social engagement (caste level effects)", --> -->
<!-- <!--      cex.main = 0.9, --> -->
...
<!-- <!-- axis(2, --> -->
<!-- <!--      at = c(1,2,3,4), --> -->
<!-- <!--      labels = c_vec[order(colMeans(ext3$b1))], --> -->
<!-- <!--      las = 2, --> -->
<!-- <!--      tck = -0.03, --> -->
<!-- <!--      col = "gray", --> -->
<!-- <!--      cex = 0.8) --> -->
<!-- <!-- axis(1, --> -->
<!-- <!--      at = seq(-0.1,0.7, by = 0.2), --> -->
<!-- <!--      col = "gray", --> -->
<!-- <!--      cex = 0.8) --> -->
<!-- <!-- abline(h = c(1,2,3,4), --> -->
<!-- <!--        lty = 3, --> -->
<!-- <!--        col = 'gray') --> -->
<!-- <!-- l_95_caste <- l_95_caste[order(colMeans(ext3$b1))] --> -->
<!-- <!-- u_95_caste <- u_95_caste[order(colMeans(ext3$b1))] --> -->
<!-- <!-- # l_95_caste <- -1.96*apply(ext3$b1,2,sd)[order(colMeans(ext3$b1))] --> -->
<!-- <!-- # u_95_caste <- 1.96*apply(ext3$b1,2,sd)[order(colMeans(ext3$b1))] --> -->
<!-- <!-- arrows(x0 = colMeans(ext3$b1)[order(colMeans(ext3$b1))], --> -->
<!-- <!--        y0 = c(1,2,3,4), --> -->
<!-- <!--        x1 = l_95_caste, --> -->
<!-- <!--        y1 = c(1,2,3,4), --> -->
<!-- <!--        col = "gray", --> -->
...
<!-- <!--        col = "gray", --> -->
<!-- <!--        length = 0) --> -->
<!-- <!-- points(colMeans(ext3$b1)[order(colMeans(ext3$b1))], --> -->
<!-- <!--      c(1,2,3,4), --> -->
<!-- <!--      col = "black", --> -->
<!-- <!--      pch = 16, --> -->
<!-- <!--      cex = 0.8) --> -->
<!-- <!-- ``` --> -->
<!-- <!-- ```{r, echo = F} --> -->
<!-- <!-- preds_caste <- as.matrix(fit3)[,5:199] --> -->
<!-- <!-- preds_caste_all <- c() --> -->
<!-- <!-- hist(deg_74, --> -->
<!-- <!--      col = "gray", --> -->
<!-- <!--      breaks = 10, --> -->
...
<!-- sum_ext3 <- summary(fit3,  -->
<!--                     pars = c("b0", "b1","mu_r", "tau_r"), -->
<!--                     probs = c(0.025, 0.975))$summary -->
<!-- kable(signif(sum_ext3, digits = 2)) -->
<!-- ``` -->

<!-- We see that the model converges well. The coefficient on hindusim ($\beta_1$) is higher indicating that being hindu predisposes a node to a higher degree in the borrowing network if the node is more socially engaged. -->
<!-- I plot the marginal posterior distributions of the religion level slope parameters. -->

<!-- ```{r, echo = F} -->
<!-- #normal model religion -->
<!-- l_95_religion <- rep(NA, 2) -->
<!-- u_95_religion <- rep(NA, 2) -->
<!-- # -->
<!-- par(col = "gray") -->
<!-- for(i in 1:2){ -->
<!--   l_95_religion[i] <- quantile(ext3$b1[,i], probs = 0.025) -->
<!--   u_95_religion[i] <- quantile(ext3$b1[,i], probs = 0.975) -->
<!-- } -->
<!-- plot(colMeans(ext3$b1)[order(colMeans(ext3$b1))], -->
<!--      c(1,2), -->
<!--      xlim = c(-0.2,1), -->
<!--      main = "access to credit vs. social engagement (religion level effects)", -->
<!--      cex.main = 0.9, -->
<!--      pch = 16, -->
<!--      col = "black", -->
<!--      cex = 0.8, -->
...
<!-- axis(2, -->
<!--      at = c(1,2), -->
<!--      labels = r_vec[order(colMeans(ext3$b1))], -->
<!--      las = 2, -->
<!--      tck = -0.03, -->
<!--      col = "gray", -->
<!--      cex = 0.6) -->
...
<!--        lty = 3, -->
<!--        col = 'gray') -->
<!-- l_95_religion <- l_95_religion[order(colMeans(ext3$b1))] -->
<!-- u_95_religion <- u_95_religion[order(colMeans(ext3$b1))] -->
<!-- # l_95_religion <- -1.96*apply(ext3$b1,2,sd)[order(colMeans(ext3$b1))] -->
<!-- # u_95_religion <- 1.96*apply(ext3$b1,2,sd)[order(colMeans(ext3$b1))] -->
<!-- arrows(x0 = colMeans(ext3$b1)[order(colMeans(ext3$b1))], -->
<!--        y0 = c(1,2), -->
<!--        x1 = l_95_religion, -->
<!--        y1 = c(1,2), -->
...
<!-- ### Posterior predictive checking -->
<!-- I now engage in posterior predictive checking. Using the normal model I predict the degree distribution for the borrowing network and compare it to the raw data. I plot the histogram of the raw data. The light blue lines are simulated values for the dependent variable (degree of nodes in the borrowing network). The black line is the true density distribution of the dependent variable. I plot the posterior predictive checks for the model. -->
<!-- ```{r, echo=F} -->
<!-- #posterior predictive check -->
<!-- preds_religion <- as.matrix(fit3)[,6:192] -->
<!-- preds_religion_all <- c() -->
<!-- hist(deg_74, -->
<!--      col = "gray", -->
<!--      breaks = 10, -->
<!--      freq = F, -->
...
<!--      xlab = "degree distribution") -->
<!-- for(i in 1:1000){ -->
<!--   preds_plot <- sample(preds_religion, 1000) -->
<!--   preds_religion_all <- c(preds_religion_all, mean(preds_plot)) -->
<!--   lines(density(preds_plot), -->
<!--         col=brewer.pal(3,"Blues")) -->
<!-- } -->
<!-- lines(density(deg_74), -->
...
<!-- ```{r, echo = F} -->
<!-- ext4 <- extract(fit4) -->
<!-- # print(fit4, pars = c("b1","mu_r")) -->
<!-- sum_ext4 <- summary(fit4,  -->
<!--                     pars = c("b1","mu_r"), -->
<!--                     probs = c(0.025, 0.975))$summary -->
<!-- kable(signif(sum_ext4, digits = 2)) -->
<!-- ``` -->
...
<!-- par(col = "gray") -->
<!-- for(i in 1:2){ -->
<!--   l_95_religion[i] <- quantile(ext4$b1[,i], probs = 0.025) -->
<!--   u_95_religion[i] <- quantile(ext4$b1[,i], probs = 0.975) -->
<!-- } -->
<!-- plot(colMeans(ext4$b1)[order(colMeans(ext4$b1))], -->
<!--      c(1,2), -->
<!--      xlim = c(-0.2,1.2), -->
<!--      main = "access to credit vs. social engagement (religion level effects)", -->
<!--      cex.main = 0.9, -->
...
<!-- axis(2, -->
<!--      at = c(1,2), -->
<!--      labels = r_vec[order(colMeans(ext4$b1))], -->
<!--      las = 2, -->
<!--      tck = -0.03, -->
<!--      col = "gray", -->
<!--      cex = 0.6) -->
...
<!--        lty = 3, -->
<!--        col = 'gray') -->
<!-- l_95_religion <- l_95_religion[order(colMeans(ext4$b1))] -->
<!-- u_95_religion <- u_95_religion[order(colMeans(ext4$b1))] -->
<!-- # l_95_religion <- -1.96*apply(ext4$b1,2,sd)[order(colMeans(ext4$b1))] -->
<!-- # u_95_religion <- 1.96*apply(ext4$b1,2,sd)[order(colMeans(ext4$b1))] -->
<!-- arrows(x0 = colMeans(ext4$b1)[order(colMeans(ext4$b1))], -->
<!--        y0 = c(1,2), -->
<!--        x1 = l_95_religion, -->
<!--        y1 = c(1,2), -->
<!--        col = "gray", -->
...
<!--        length = 0, -->
<!--        lwd = 1.5) -->
<!-- points(colMeans(ext4$b1)[order(colMeans(ext4$b1))], -->
<!--      c(1,2), -->
<!--      col = "black", -->
<!--      pch = 16, -->
<!--      cex = 0.8) -->
...
<!-- ```{r, echo=F} -->
<!-- preds_religion <- as.matrix(fit4)[,4:193] -->
<!-- preds_religion_all <- c() -->
<!-- hist(deg_74, -->
<!--      col = "gray", -->
<!--      breaks = 10, -->
